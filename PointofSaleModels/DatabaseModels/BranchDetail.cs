...
public partial class BranchDetail
{
    ...
    public virtual BranchMaster? AlternateBranch1Navigation { get; set; }

    public virtual BranchMaster? AlternateBranch2Navigation { get; set; }

    public virtual BranchMaster? AlternateBranch3Navigation { get; set; }
